...
print(arquivo)
nome_arquivo, extencao_arquivo = os.path.splitext(caminho)
print(nome_arquivo, extencao_arquivo)
nome_arquivo, extencao_arquivo = os.path.splitext(arquivo)
print(nome_arquivo, extencao_arquivo)


print(os.path.exists(caminho))
print(os.path.exists('\\Users\\JEFFERSON_PC\\Documents\\ProjetoPython'))
